...
function Mouse_Col_Gui(){
	...
	if point_in_rectangle(device_mouse_x_to_gui(0), device_mouse_y_to_gui(0), spriteleft, spritetop, spriteright, spritebottom) {
		...
		if mouse_check_button_pressed(mb_left) { result = 2; }	//left click
		
		//if mouse_check_button_pressed(mb_right) { result = 3; } //right click   //Not using it right now
    }
